...
class DoctorTests(unittest.TestCase):
    ...
    def test_package_version_check_reports_matching_source_and_distribution(
        ...
        self.assertEqual(result.status, "pass")
        self.assertEqual(result.details["package_version"], "3.13.0")
        self.assertEqual(result.details["distribution_version"], "3.13.0")
        self.assertEqual(result.details["project_version"], "3.13.0")
